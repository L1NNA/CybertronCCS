...
class LSTMC(BaseModel):

    def __init__(self, max_seq_len=512, name=None):
        super(LSTMC, self).__init__(max_seq_len=max_seq_len,
    ...
    def build(self):
        ...
        l_h2 = Bidirectional(LSTM(128, return_sequences=True))
        l_h3 = Bidirectional(LSTM(128, return_sequences=False))
        l_dense = Dense(128)
